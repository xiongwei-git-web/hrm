...
<div class="row  border ">
                    ...
                    <form action="/section/add" method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="text1" class="col-form-label">部门名称</label>
                                <input type="text"  name="sName" class="form-control" id="text1">
                            </div>
                            <div class="form-group">
                                <label for="text2" class="col-form-label">部门详情</label>
                                <input type="text"   class="form-control" name="sShow" id="text2">
                            </div>
                        </div>
    ...
    <div class="col-5 ">
        <form action="/section/selectname" method="post">
        <div class="input-group ">
            <span class="input-group-append align-items-center ">搜索：</span>
            <input type="text" name="sName" class="form-control" placeholder="请输入搜索部门的名称">
    ...
    <div class="col-12">
            ...
            <table class="table" id="table">
                ...
                <tr>
                    ...
                    <th scope="col">部门详情</th>
                    <th scope="col">操作</th>
                </tr>

                </thead>
                <tbody>
                <form id="formid" action="/section/deletes" method="post">
                ...
                <div class="modal fade" id="update" tabindex="-1" role="dialog" aria-labelledby="updates" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="updates">修改部门</h5>
                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <form action="/section/updaet" method="post">
                                <div class="modal-body">

                                    <div class="form-group">
                                        <label for="text1" class="col-form-label">部门名称</label>
                                        <input type="text"  name="sName" class="form-control" id="text3">
                                    </div>
                                    <div class="form-group">
                                        <label for="text2" class="col-form-label">部门详情</label>
                                        <input type="text"   class="form-control" name="sShow" id="text4">
                                        <input type="hidden" name="sId" id="text5">
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">关闭</button>
...
<div class="row">
    ...
    <div class="col-8" >
        <ul class="list-inline pagination text-center">
            <li   class="list-inline-item disabled"><a id="li1" onclick="tage1()" href="/section/selectall?pagenum=${list.pageNum-1}"><i class="fa fa-chevron-left fa-lg"></i>上一页</a></li>
            <li class="list-inline-item"><a id="li2" onclick="tage1()" href="/section/selectall?pagenum=${list.pageNum+1}"><i class="fa fa-chevron-right fa-lg"></i>下一页 </a></li>
        </ul>
    </div>
...
<script type="text/javascript">
    ...
    function deleterow(obj) {
        ...
        xmlhttp.open("get","/section/delete?id=" + id, true);
        xmlhttp.send();
